package com.chapter3.Exercises.exercise4;
...
public class PrintSquare {
    ...
    When the sequence in any line reaches max, it wraps around back to min.
     ...
     assume the caller of the method will pass a min and a max parameter such that min is less than or equal to max.
     */
